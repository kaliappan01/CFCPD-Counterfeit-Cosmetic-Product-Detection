...
<html lang="en">
  <head>
    ...
    <title>CFCPD - Supply Chain DAPP</title>
  ...
  <center>
    ...
    <div style="width: 100%">
      ...
      <h3 style = "padding: 50px; font-weight: 900">  <b>Welcome to CFCPD</b>   </h3>
      <p style="font-weight: bold;">
          <b>  CFCPD is a Decentralized E2E Logistics Application that stores the whereabouts of product at every freight hub on the Blockchain. At consumer end, customers can simply scan the QR CODE of products and get complete information about the provenance of that product hence empowering consumers to only purchase authentic and quality products.
  </b></p>
  ...
  <!-- </div> -->
      ...
      <div class="loginformcard" id="maincard3">
            ...
            <br>
            <a href="#" id="gotologin" style="color: white"> Already have an account? Login to your existing account </a>
            </form>
      </div>
      ...
      <h4> Login to your existing account</h4>
            ...
            <br>
            <a href="#" id="gotosignup" style="color: white"> Don't have an account? Create a new account now</a>
            </form>
